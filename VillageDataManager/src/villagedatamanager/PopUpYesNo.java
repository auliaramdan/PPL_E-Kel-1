 ...
 */
public class PopUpYesNo extends javax.swing.JFrame {

    /**
     * Creates new form PopUpYesNo
     */
    ControlOrang ctrlorg;
    ControlRumah ctrlrmh;
    int arg;
    public PopUpYesNo(ControlOrang a, int b) {
        initComponents();
        ctrlorg = a;
        ctrlrmh = null;
        arg = b;
    }
    public PopUpYesNo(ControlRumah a, int b) {
        initComponents();
        ctrlorg = null;
        ctrlrmh = a;
        arg = b;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpYesNo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
